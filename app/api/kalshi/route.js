...
const SPORTS_SERIES = [
  ...
  'KXEREDIVISIEGAME', 'KXDANISHSUPERLIGAGAME', 'KXUCLGAME',
  // 기타 스포츠
  'KXUFCFIGHT', 'KXPGATOUR', 'KXTENNISEXHIBITION', 'KXTENNISGAME',
  'KXF1RACE', 'KXCSGOGAME',
  // *** 챔피언십/파이널 (Polymarket과 겹칠 가능성 높음) ***
  'KXNBA', 'KXNBAEAST', 'KXNBAWEST', 'KXNBAMVP', 'KXNBACUP',
  'KXNFL', 'KXNFLAFCCHAMP', 'KXNFLNFCCHAMP', 'KXNFLMVP',
  'KXMLB', 'KXMLBAL', 'KXMLBNL', 'KXMLBMVP',
  'KXNHL', 'KXNHLMVP',
  'KXWNBA', 'KXMLSCUP', 'KXUFC'
];
